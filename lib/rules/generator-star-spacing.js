...
module.exports = function(context) {
    ...
    /**
     * Checks whether the current node is a class or object method.
     * @returns {boolean} True if the current node is a method.
     */
    function isMethod() {
        var parent = context.getAncestors().pop();
        return (parent.method || parent.type === "MethodDefinition");
    }
    ...
    function checkFunction(node) {
        var starToken, tokenBefore, tokenAfter;
